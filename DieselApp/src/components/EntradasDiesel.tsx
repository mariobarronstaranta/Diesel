...
export default function EntradasDiesel() {
  ...
  const onSubmit = async (data: EntradasForm) => {
    ...
    try {
      ...
      console.error("[EntradasDiesel] Error saving entry:", err);
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    {...register("LitrosCarga", {
                      required: "Litros requeridos",
                    })}
                    isInvalid={!!errors.LitrosCarga}
                  />
                  <Form.Control.Feedback type="invalid">
                    {errors.LitrosCarga?.message}
                  </Form.Control.Feedback>
                </Form.Group>
              </Col>
              <Col md={4}>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    {...register("CuentaLitros", {
                      required: "Cuenta litros requerido",
                    })}
                    isInvalid={!!errors.CuentaLitros}
                  />
                  <Form.Control.Feedback type="invalid">
                    {errors.CuentaLitros?.message}
                  </Form.Control.Feedback>
                </Form.Group>
              </Col>
            </Row>
              ...
              <Col md={6}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    type="text"
                    {...register("Remision", {
                      required: "Remisión requerida",
                    })}
                    isInvalid={!!errors.Remision}
                  />
                  <Form.Control.Feedback type="invalid">
                    {errors.Remision?.message}
                  </Form.Control.Feedback>
                </Form.Group>
              </Col>
            </Row>
